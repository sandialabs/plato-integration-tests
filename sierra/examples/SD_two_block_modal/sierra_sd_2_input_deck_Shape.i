...
END
INVERSE-PROBLEM
  data_truth_table eigen_vector_ttable_sierra_sd_2.txt
  data_file eigen_vector_data_sierra_sd_2.txt
  modal_data_file modal_data_sierra_sd_2.txt
  modal_weight_table modal_weight_table_sierra_sd_2.txt
  shape_sideset 4
  shape_bounds 1.0
  eigen_objective mpe
